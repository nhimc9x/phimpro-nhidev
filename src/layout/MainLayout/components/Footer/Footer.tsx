  ...
  return (
    <div className="px-2 py-10 w-full max-w-[1600px] mx-auto text-center bg-ct-primary">
      ...
      <div className="flex justify-center items-center gap-4 mb-6">
        <a href="https://portfolio-nhideveloper.vercel.app" className="text-ct-text-color text-3xl hover:text-ct-highlight-color transition-all duration-200">
          <FaFacebookSquare />
        </a>
      ...
      <div className="text-sm text-ct-text-color font-light tracking-wide">
        ...
        &#10084; <a href="https://portfolio-nhideveloper.vercel.app" className="text-ncs-active-color">Nhidev</a>
      </div>
    </div>
  )
}
